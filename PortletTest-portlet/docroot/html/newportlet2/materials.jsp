...
<portlet:actionURL name="getMaterials" var="getMaterials"
...
$(document).ready(function() {
	...
	var request = jQuery.getJSON('<%=getMaterials%>', params);
	request.done(function(data) {
		var materialsDiv = document.getElementById("materialsBody");
		for (var i in data) {
			console.log(data[i]);
			var ref = $("<a>");
			ref
			...
			/*document.getElementById("material_" + i).innerHTML=data[i].address;*/
